  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved grant as @grant" do
        ...
        post :create, {:grant => { "amount" => "invalid value" }}, valid_session
        assigns(:grant).should be_a_new(Grant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested grant" do
        ...
        Grant.any_instance.should_receive(:update_attributes).with({ "amount" => "" })
        put :update, {:id => grant.to_param, :grant => { "amount" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the grant as @grant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Grant.any_instance.stub(:save).and_return(false)
        put :update, {:id => grant.to_param, :grant => { "amount" => "invalid value" }}, valid_session
        assigns(:grant).should eq(grant)
      end
